...
public class GestisciPropostePanel extends JPanel implements View, VisitableGuiUC1 {
    ...
    public GestisciPropostePanel(ArrayList<Proposta> proposteArrLst) {
    ...
    private void init() {
        System.out.println("Inizzializzazione Pannello Gestione Proposte...");   //comunicazione di controllo per i log
